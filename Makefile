...
#    Updated: 2023/03/13 17:48:02 by miandrad         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
run: $(NAME)
	@./pipex aa "notexisting" "wc -m" bb

valgrind: $(NAME)
	@valgrind --leak-check=full --track-origins=yes --show-leak-kinds=all ./pipex aa "notexisting" "wc -m" bb
